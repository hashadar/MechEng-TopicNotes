...
z1 = [normpdf(fshift, 1.2, 0.01)' + normpdf(fshift, -1.2, 0.01)'];%generate and add gaussians
z2 = [normpdf(fshift, 1.2, 0.1)' + normpdf(fshift, -1.2, 0.1)'];%generate and add gaussians
z3 = [normpdf(fshift, 1.2, 0.001)' + normpdf(fshift, -1.2, 0.001)'];%generate and add gaussians
filtData1 = abs(yshift).*z1; %multiply FT signal data with gaussian 0.1
filtData2 = abs(yshift).*z2; %multiply FT signal data with gaussian 0.01
filtData3 = abs(yshift).*z3; %multiply FT signal data with gaussian 0.001
