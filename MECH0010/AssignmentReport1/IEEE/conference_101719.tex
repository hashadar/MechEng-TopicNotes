...
\author{\IEEEauthorblockN{1\textsuperscript{st} Hasha Dar}
\IEEEauthorblockA{
hasha.dar.19@ucl.ac.uk}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Christopher Tawk}
\IEEEauthorblockA{
christopher.tawk.19@ucl.ac.uk}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Xichen Yang}
\IEEEauthorblockA{
...
Model of the open loop transfer function of angular velocity in Simulink:

\begin{figure}[htbp]
    \centerline{\includegraphics[width = 0.45\textwidth]{../img/placeholder2.png}}
    \caption{Model of open loop transfer function of angular velocity with impulse input.}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width = 0.45\textwidth]{../img/placeholder1.png}}
