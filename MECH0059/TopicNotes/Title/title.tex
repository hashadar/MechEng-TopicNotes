\begin{titlepage}
  ...
  \textsc{\large MECH0059 Advanced Computer Applications in Engineering }\\[1.5cm] % Minor heading such as course title
  ...
  \begin{minipage}{0.4\textwidth}
    \begin{flushright} \large
      ...
      Dr. Mehran Moazen \\[1.2em] % Supervisor's Name
      \emph{Module tutor:} \\
      Prof. Yiannis Ventikos % second marker's name
    \end{flushright}
  \end{minipage}\\[2cm]
  \makeatother
