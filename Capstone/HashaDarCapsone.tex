...
\end{itemize}
The diameter of a gear is simply $d = mz$ and for two gears to mesh, their module must be the same. Hence, we can derive
\begin{gather}
  m_1 = m_2\\
...
\begin{figure}
  \centering
  \includegraphics[width = 0.5 \textwidth]{./img/GearRadii.jpg}
