...
Steel is cheap and available in a range of strengths. It is also tough and ductile. Steel is heat-treatable and alloys with many other elements such as Chromium, Manganese, Nickel, changing its properties. This makes steel (and its alloys) a very versatile material, able to be mass produced and manufactured easily, to suit a multitude of use cases.
...
Let us think about the failure modes which may occur in a gearbox involving the gears. Gear teeth can wear and break. Hence, we require steel with good (surface) hardness. As a side note, we may utilise lubrication to reduce the impact of shear forces on the gear. This will also help in keeping dirt and debris away from our gears. 

The gear will be subjected to cycles of loading and unloading (use and disuse), thus the steel should have good fatigue strength. The way our gear is designed will also impact this property, e.g. making sure there are no stress concentrations and making sure there is a good surface finish/contact. 

We must also consider the operating conditions of our gears. Since our gearbox will be housed in the nacelle of the turbine, we can assume that our gearbox will be protected from weather. The gearbox will still undergo temperature changes however these fluctuations are comparatively minor. In 2019, the UK's average temperatures in summer and winter were 15.1\si{\celsius} and 5.2\si{\celsius}, with highest and lowest mean daily temperatures being 22.2\si{\celsius} and -2.1\si{\celsius} \citep{UKTemperatureData}. 
