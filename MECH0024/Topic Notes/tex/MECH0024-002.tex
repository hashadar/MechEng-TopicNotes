...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{../img/hd/diagram1.png}
    \caption{Streamline.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{../img/hd/diagram2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.7\textwidth]{../img/hd/diagram5.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.5\textwidth]{../img/hd/diagram6.png}
